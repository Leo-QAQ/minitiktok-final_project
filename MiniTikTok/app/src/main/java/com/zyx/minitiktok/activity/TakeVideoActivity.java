...
public class TakeVideoActivity extends BaseActivity {
            ...
            public void onClick(View view) {
                if (isRecording) {
                    ...
                    handler.postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent intent = new Intent(TakeVideoActivity.this, MainActivity.class);
    ...
    protected void onResume() {
        super.onResume();
        if (ActivityCompat.checkSelfPermission(TakeVideoActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            Toast.makeText(TakeVideoActivity.this, "未授予全部权限！", Toast.LENGTH_SHORT).show();
            finish();
        } else if (ActivityCompat.checkSelfPermission(TakeVideoActivity.this, Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED || ActivityCompat.checkSelfPermission(TakeVideoActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            Toast.makeText(TakeVideoActivity.this, "未授予全部权限！", Toast.LENGTH_SHORT).show();
            finish();
        }
    }
    ...
    public Camera getCamera(int position) {
        ...
        Camera.Size size = getOptimalPreviewSize(parameters.getSupportedPreviewSizes(), sv.getWidth(), sv.getHeight());
